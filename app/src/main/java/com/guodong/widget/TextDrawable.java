...
public class TextDrawable extends AppCompatTextView {
    ...
    public TextDrawable setIconNormal(Drawable icon) {
    ...
    public TextDrawable setIconPressed(Drawable icon) {
    ...
    public TextDrawable setIconUnable(Drawable icon) {
    ...
    public TextDrawable setIconSize(int iconWidth, int iconHeight) {
    ...
    public TextDrawable setIconWidth(int iconWidth) {
        this.mIconWidth = iconWidth;
        setIcon();
        return this;
    }
    ...
    public TextDrawable setIconHeight(int iconHeight) {
        this.mIconHeight = iconHeight;
        setIcon();
        return this;
    }
    ...
    public TextDrawable setIconDirection(int iconDirection) {
    ...
    public TextDrawable setTextColorNormal(int textColor) {
    ...
    public TextDrawable setPressedTextColor(int textColor) {
    ...
    public TextDrawable setTextColorUnable(int textColor) {
    ...
    public TextDrawable setBorderWidthNormal(int width) {
    ...
    public TextDrawable setBorderColorNormal(int color) {
    ...
    public TextDrawable setBorderWidthPressed(int width) {
    ...
    public TextDrawable setBorderColorPressed(int color) {
    ...
    public TextDrawable setBorderWidthUnable(int width) {
    ...
    public TextDrawable setBorderColorUnable(int color) {
    ...
    public TextDrawable setCornerRadiusTopLeft(float topLeft) {
    ...
    public TextDrawable setCornerRadiusTopRight(float topRight) {
        this.mCornerRadius = -1;
    ...
    public TextDrawable setCornerRadiusBottomRight(float bottomRight) {
        this.mCornerRadius = -1;
    ...
    public TextDrawable setCornerRadiusBottomLeft(float bottomLeft) {
        this.mCornerRadius = -1;

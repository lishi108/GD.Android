    ...
    protected void initData() {
        ...
        ptrFrameLayout.setPtrHandler(new PtrHandler() {
            ...
            public void onRefreshBegin(PtrFrameLayout frame) {
                mPresenter.getBannerImage(mContext);
        ...
        mLoadMoreWrapper.setLoadMoreView(R.layout.loadmore);
        ...
        homeRecyclerView.setAdapter(mLoadMoreWrapper);
        mPresenter.getBannerImage(mContext);
        mPresenter.getGameData(mContext);
        mPresenter.getHotEquipment(mContext);
    }
...
//            mHeaderAndFooterWrapper.notifyDataSetChanged();
    ...
    private void initHeaderAndFooter() {
        ...
        //轮播View
        bannarView = layoutInflater.inflate(R.layout.item_banner, null);
        ...
        //横向列表View
        gameListView = layoutInflater.inflate(R.layout.horizontal_recyclerview, null);
...
//        });
        //热门type
        View hotView = layoutInflater.inflate(R.layout.item_type_hot, null);
    ...
    public void onDestroyView() {
        super.onDestroyView();
        if (bannerViewHolder != null) bannerViewHolder.clear();
    }
}
